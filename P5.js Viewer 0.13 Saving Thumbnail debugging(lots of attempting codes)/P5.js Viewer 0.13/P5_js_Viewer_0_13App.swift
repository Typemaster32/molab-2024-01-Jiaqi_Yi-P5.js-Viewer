...
// Big Stuff:
// 1. Save Animation
// 2. Touch Interaction / Wake Keyboard  (TOO HARD) (KEEPS Refreshing)
// 3. Resize the canvas to fit viewport （TOO HARD）(ZOOMing has a bug)
// 4. Handle Fullscreen to stop (DONE)
// 5. Save My Collection
// 6. Examples Refreshes (DONE)
// 7. More Tags (CURRENTLY NO NEED)
// 8. Ban downloads (ALMOST DONE)
// 9. Search Sketches of the Artist
// 10. Examples updates (Better to use URL + image)
