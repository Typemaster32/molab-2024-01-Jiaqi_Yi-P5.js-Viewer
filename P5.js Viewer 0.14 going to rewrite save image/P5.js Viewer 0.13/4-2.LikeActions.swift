...
func UnlikeAction(likesManager: LikesManager , p5id:String, viewModel: ViewModelOfFirebaseStatus){
    print("---[Button][Unlike]---")
...
func LikeAction(likesManager: LikesManager , p5id:String, viewModel: ViewModelOfFirebaseStatus){
    print("---[Button][Like]---")
