...
struct WebContentView: View {
    var sourceURL: URL //This is an local URL
    var originURL: URL? = nil //This is the p5.js web editor URL
    var title: String
    var author: String
    ...
    @State private var buttonText = "Like" // This is controlling the button to show "Like" or "Publish"
            ...
            VStack {
                ...
                HStack {
                    Button("Like") {
                        ...
                        // Publish: generate thumbnail (higher version) -> fulfill thisItem -> upload thumbnail with storage -> addDocument(thisItem)
                        var thisItem = Item(
                            id: "",
                            title: title,
                            author: author,
                            createdAt: createdAt,
                            updatedAt: updatedAt,
                            thumbnailURL: sourceURL ?? defaultThumbnailURL, // Use sourceURL if not nil, else use defaultThumbnailURL
                            sketchURL: originURL ?? defaultSketchURL
                        )
                        // Like if it is published;
                        // Like: get the id of this WebContentView -> find it with id -> update with new value of Like
                        // Show as gray if it is liked;
                        // Liked: Change the property of this button here.
                    }
