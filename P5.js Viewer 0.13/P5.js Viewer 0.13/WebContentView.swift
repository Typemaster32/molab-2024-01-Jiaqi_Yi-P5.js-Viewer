        ...
        GeometryReader { geometry in
            VStack {
                ...
                Button("Start Animation Capture") {
                    if let unzippedURL = unzippedContentURL {
                        saveAnimation = SaveAnimation(url: unzippedURL) {
                            // Optionally, do something when capture and processing are complete
                            print("Animation capture and processing are complete.")
                            self.saveAnimation = nil // Clear the reference once done
                        }
                    }
                }
                .foregroundColor(.blue)
