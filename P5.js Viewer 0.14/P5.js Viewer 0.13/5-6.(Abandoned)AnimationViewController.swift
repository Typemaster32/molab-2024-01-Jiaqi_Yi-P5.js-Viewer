...
class AnimationManager {
    ...
    init(sketchTitle: String, author: String, folderURL: URL) {
        ...
        if self.webView != nil {
            print("[AnimationViewController][init]: WebView is successfully initialized and ready for use.")
        } else {
            print("[AnimationViewController][init]: WebView failed to initialize.")
        }
    ...
    func saveAnimationAction() {
        ...
        DispatchQueue.global(qos: .userInitiated).async { [weak self] in
            ...
            DispatchQueue.main.async { [self] in
                ...
                print("[SaveAnimationAction][Check]: Checking existence of index.html at \(self.indexPath.path)")
                if FileManager.default.fileExists(atPath: self.indexPath.path) {
                    ...
                    print("[SaveAnimationAction][Error]: index.html not found at \(self.indexPath.path).")
                }
            }
        }
    }
